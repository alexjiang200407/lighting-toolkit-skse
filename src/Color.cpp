...
preset::Color::Color(RE::NiColor color, bool isCustom) : Color("Unnamed Color", color, isCustom) {}
...
Color preset::Color::Clone(bool isCustom) const { return Clone(GetName(), isCustom); }
